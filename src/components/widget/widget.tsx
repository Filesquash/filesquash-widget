...
export class FilesquashWidget {
  ...
  @Prop() labelText: string = 'Drop files here or click to select.';
  @Prop() uploadButtonText: string = 'Upload';
  @Prop() localFilesTitle: string = 'Local Files';
  @Prop() selectedFilesText: string = 'Selected files';
