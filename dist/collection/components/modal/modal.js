export class FilesquashModal {
    ...
    render() {
        return this.modalVisible ? (h("div", { class: "modal", onClick: this.toggleModal.bind(this) },
    ...
    static get is() { return "filesquash-modal"; }
    ...
    static get style() { return "/**style-placeholder:filesquash-modal:**/"; }
}
