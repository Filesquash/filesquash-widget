...
var FilesquashWidget = /** @class */ (function () {
    ...
    FilesquashWidget.prototype.toggleModal = function (event) {
        if (event)
            event.stopPropagation();
        this.modalVisible = !this.modalVisible;
    };
    FilesquashWidget.prototype.readFile = function (files) {
        var _this = this;
        if (files) {
    ...
    FilesquashWidget.prototype.removeFile = function (index) {
        var selectedFilesCopy = this.selectedFiles.slice();
        selectedFilesCopy.splice(index, 1);
        this.selectedFiles = selectedFilesCopy;
    };
    FilesquashWidget.prototype.noop = function (event) {
        event.stopPropagation();
    };
    FilesquashWidget.prototype.sendFile = function (file, token) {
    ...
    FilesquashWidget.prototype.upload = function (files, token) {
        var _this = this;
    ...
    FilesquashWidget.prototype.renderImagePreview = function (base64, filename, index) {
        var _this = this;
    ...
    FilesquashWidget.prototype.renderPlaceholder = function (type, filename, index) {
        var _this = this;
    ...
    FilesquashWidget.prototype.renderFilePreview = function (item, index) {
    ...
    FilesquashWidget.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "filesquash-widget" }, h("button", { type: "button", class: "btn", onClick: this.toggleModal.bind(this) }, this.buttonText), this.modalVisible && (h("div", { class: "modal", onClick: this.toggleModal.bind(this) }, h("div", { class: "modal-content", onClick: this.noop.bind(this) }, h("h2", { class: "title" }, this.localFilesTitle), h("button", { type: "button", class: "btn-icon", onClick: this.toggleModal.bind(this) }, h("svg", { viewBox: "0 0 32 32", id: "icon-close", width: "100%", height: "100%" }, h("path", { d: "M10.06 7.94a1.5 1.5 0 0 0-2.12 2.12L13.878 16l-5.94 5.94a1.5 1.5 0 0 0 2.122 2.12L16 18.122l5.94 5.94a1.5 1.5 0 0 0 2.12-2.122L18.122 16l5.94-5.94a1.5 1.5 0 0 0-2.122-2.12L16 13.878l-5.94-5.94z" }))), h("div", { class: "filesquash-form" }, h("label", null, this.labelText, h("input", { type: "file", class: "file-upload", onChange: function (e) { return _this.readFile(e.target.files); }, multiple: this.multiple }))), this.selectedFiles.length > 0 && [
